/* AUTO-GENERATED from src/time.js — do not edit.
   Regenerate with: npm run build:demo */
window.DiningTime = (function () {
  'use strict';
/**
...
function serviceHasFinished(serviceDate, mealKey, timeZone, now = new Date()) {
  ...
  return { MEALS, MEAL_KEYS, zoneOffsetMs, wallTimeToInstant, hotelParts, hotelToday, isValidDateString, parseDateString, addDays, diffDays, cutoffInstant, serviceWindowInstants, mealStatus, serviceHasFinished };
})();
